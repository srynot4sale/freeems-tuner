...
class test_doubleStart(test_definition):
    ...
    results = ['ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA [0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC]',
...
class test_incompleteFirst(test_definition):
    ...
    results = ['ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F [0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC]',
               'Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC']
...
class test_twoIncompleteFirst(test_definition):
    ...
    results = ['ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F [0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC]',
               'ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F [0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC]',
               'Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x01,0xFF,0x0F,0xCC']
...
class test_badBytesBetweenPackets(test_definition):
    ...
    results = ['Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC',
               'ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA [0xAA,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC,0x56,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC]',
               'ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer missing end byte 0xAA [0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC,0x56,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC]',
               'Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC',
               'ERROR msg from test_receive: processReceiveBuffer could not parse buffer. Bad/incomplete packet found in buffer before start byte 0x56 [0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC,0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC]',
               'Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC',
               'Packet returned: 0xAA,0x08,0x00,0x05,0x00,0x02,0x00,0xFE,0x0D,0xCC']
